...
class globalwarmingquiz extends StatefulWidget {
  const globalwarmingquiz({Key? key});

  @override
  State<globalwarmingquiz> createState() => _globalwarmingquizState();
}

class _globalwarmingquizState extends State<globalwarmingquiz> {
  List<String> answers = [
    "Oxygen (O2)",
    "Nitrogen (N2)",
    "Carbon Dioxide (CO2)",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Global Warming Quiz"),
        elevation: 0,
      ),
      body: Column(
        children: [
