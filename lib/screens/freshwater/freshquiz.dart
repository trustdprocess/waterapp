...
class freshwaterquiz extends StatefulWidget {
  const freshwaterquiz({Key? key});

  @override
  State<freshwaterquiz> createState() => _freshwaterquizState();
}

class _freshwaterquizState extends State<freshwaterquiz> {
  List<String> answers = [
    "1000 miligrams/litre",
    "200 milligrams/litre",
    "100 miligrams/litre",
    "10000 miligrams/litre"
  ];
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
              "What is the concentration of dissolved salts in freshwater?",
              style: TextStyle(
                fontSize: 20,
              ),
            ),
